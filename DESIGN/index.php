			...
			<ul class="rslides callbacks callbacks1" id="slider4">
				<li>
					<div class="banner-top1">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>Welcome to Online Blood Bank System
									<span>your trusted platform for secure, efficient, and reliable blood donation and transfusion services</span>
								</h3>
				...
				<li>
					<div class="banner-top2">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>Join our Online Blood Bank System to make a difference today 
									<span>donate or request blood seamlessly and help save lives</span>
								</h3>
